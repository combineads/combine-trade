# T-15-001 GitHub Actions CI workflow
...
## Why
Every code change must be validated automatically before it can reach production. Without a CI pipeline, there is no automated guard against broken builds, failing tests, or type errors slipping into `main`. This is the foundation all other quality and security gates (T-15-002, T-15-003, T-15-010) extend.
...
## Out of Scope
- Coverage gate job — T-15-002
- Performance regression gate — T-15-002
- Security audit and secret scanning jobs — T-15-003
- Sandbox escape test job — T-15-003
- Docker image build workflow — T-15-004, T-15-005, T-15-006
- Release workflow — T-15-010
- PR lint workflow — T-15-010
