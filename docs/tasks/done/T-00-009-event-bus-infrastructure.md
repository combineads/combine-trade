# T-00-009 Implement event bus infrastructure
...
- T-00-001 outputs: `packages/shared/` directory
- T-00-002 outputs: running PostgreSQL instance

## Dependencies
- T-00-001 (monorepo structure with packages/shared/)
- T-00-002 (PostgreSQL for integration testing)
...
7. Write integration tests (requires PostgreSQL from T-00-002):
