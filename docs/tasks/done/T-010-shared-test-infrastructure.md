# T-010 Create shared test infrastructure
...
- T-001 outputs: `packages/exchange/` directory
- T-002 outputs: Docker PostgreSQL for test DB
- T-003 outputs: DrizzleORM schemas for DB setup/teardown

## Dependencies
- T-001 (monorepo structure)
- T-002 (PostgreSQL for test DB lifecycle)
- T-003 (schemas for DB setup/teardown)
...
- Generated candles must pass continuity validation (T-005)
