# T-08-028 Wire remaining API routes to server
...
## Dependencies
- T-08-020 (base API server scaffold with first routes mounted)
...
- Follow existing route mounting pattern established in T-08-020
...
- Auth middleware (T-08-029)
- Journal and paper trading routes (T-08-030, T-08-031)
