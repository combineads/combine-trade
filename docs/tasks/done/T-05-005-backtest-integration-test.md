# T-05-005 Backtest integration test
...
## Inputs
- T-05-001 `parseBinanceVisionCsv` — CSV → Candle[]
- T-05-002 `runBacktest`, `BacktestEngineDeps`, `BacktestResult` — replay engine
- T-05-003 `labelBacktestEvent`, `ResultConfig` — inline labeler
- T-05-004 `computeReport`, `LabeledEvent`, `BacktestReport` — statistics report
- T-04-001 `LabelResult` — label type
- T-04-003 integration test as structural reference (`tests/integration/label-decision.test.ts`)

## Dependencies
- T-05-002 (replay engine)
- T-05-003 (labeler integration)
- T-05-004 (statistics report)
