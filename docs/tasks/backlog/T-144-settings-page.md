# T-144 Settings page with theme, exchange, and general config
...
- `packages/ui/src/components/card.tsx` (from T-130)
- `packages/ui/src/components/button.tsx` (from T-130)
- `apps/web/src/app/layout.tsx` — ThemeProvider context (from T-128)

## Dependencies
- T-128 (packages/ui scaffold — ThemeProvider and useTheme hook)
