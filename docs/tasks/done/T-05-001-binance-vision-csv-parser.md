# T-05-001 Binance Vision CSV parser
...
## Why
The backtest replay engine (T-05-002) needs a way to ingest historical candle data from Binance Vision ZIP archives without hitting the REST API. A standalone parser isolates the format-specific logic and makes the replay engine testable with fixture strings.
