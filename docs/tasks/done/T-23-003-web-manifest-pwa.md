...
- **Files created**:
  - `apps/web/src/app/manifest.ts` — Next.js Metadata File API manifest (typed with MetadataRoute.Manifest)
  - `apps/web/__tests__/manifest.test.ts` — 10 tests covering all manifest fields and icon entries
- **Validation**: 10/10 tests pass, typecheck clean, lint clean on new files
