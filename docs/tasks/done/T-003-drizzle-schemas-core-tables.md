# T-003 Create DrizzleORM schemas for core tables
...
- T-001 outputs: monorepo structure with `packages/shared/`
- T-002 outputs: running PostgreSQL with pgvector

## Dependencies
- T-001 (monorepo structure for db/ directory and package resolution)
- T-002 (PostgreSQL instance for migration validation)
