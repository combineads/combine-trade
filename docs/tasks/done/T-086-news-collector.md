# T-086 Event-triggered news collector
...
## Inputs
- `packages/core/macro/saveticker-client.ts` (T-084 outputs: SavetickerClient.fetchRecentNews)
- `db/schema/macro.ts` (T-083 outputs: economicEvents, newsItems tables)
