# T-039 Backtest replay engine core
...
## Inputs
- T-038 `parseBinanceVisionCsv` output — `Candle[]` passed as input data
...
## Dependencies
- T-038 (CSV parser — defines `Candle[]` input shape)
...
- Vector storage / normalization (T-040 integrates these)
- Label computation (T-040)
- Statistics report (T-041)
