# T-019 Create strategies DB schema and CRUD service
...
## Dependencies
- T-003 (DrizzleORM schemas — done)
- T-006 (IoC container — done)
...
## Out of Scope
- Code validation (T-020)
- Strategy activation/deactivation workflow (T-020)
