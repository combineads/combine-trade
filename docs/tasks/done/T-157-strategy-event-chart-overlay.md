# T-157 Strategy event chart overlay
...
## Inputs
- `LightweightChart` component and `ISeriesApi` ref from T-155
...
## Dependencies
- T-155 (LightweightChart component with series ref)
