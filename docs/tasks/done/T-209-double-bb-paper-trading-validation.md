# T-209 Double-BB paper trading validation & readiness score
...
Paper trading 코드(T-068~T-072)와 readiness score 모듈(T-072)은 이미 구현되어 있다.

## Inputs
- T-208: 실시간 파이프라인 e2e 검증 완료
- T-072 결과물: `ReadinessScoreCalculator` (packages/core/paper)
...
## Out of Scope
Live 배포 (T-210), 새 전략 추가, multi-symbol 운영
