# T-146 Persistent notification banner component
...
- `packages/ui/src/components/button.tsx` (from T-130) — for optional dismiss button on non-critical variants

## Dependencies
- T-130 (base UI components — design tokens, button)
...
- Banner animation
- PaperTradingBanner (T-150 — separate amber banner variant)
- TopBar integration (T-147 — depends on this task)
