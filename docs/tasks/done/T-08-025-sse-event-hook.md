# T-08-025 SSE client hook for real-time events
...
- `packages/ui/src/hooks/` — existing hooks directory (from T-08-013)

## Dependencies
- T-08-013 (API client hooks — establishes hooks directory and API base URL pattern)
...
- Wiring to specific monitoring pages (T-08-032 integration task)
