...
export const BB20_CONFIG = { length: 20, stddev: 2, source: "close" } as const;
export const BB4_CONFIG = { length: 4, stddev: 4, source: "close" } as const;
...
export const ENTRY_TIMEFRAMES = ["5M", "1M"] as const;
...
// Supported exchanges
export const SUPPORTED_EXCHANGES = ["binance", "okx", "bitget", "mexc"] as const;

// Supported symbols
export const SUPPORTED_SYMBOLS = ["BTCUSDT", "XAUTUSDT"] as const;
