...
## Inputs
- `packages/core/macro/prompt-builder.ts` (T-16-007 outputs: buildRetrospectivePrompt)
- `packages/core/macro/types.ts` (T-16-001 outputs: MacroContext)
