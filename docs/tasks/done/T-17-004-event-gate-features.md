# T-17-004 Event gate + feature definitions + ATR TP/SL
...
## Inputs
- `packages/core/strategy/double-bb/detector.ts` (T-17-002: DoubleBBResult)
- `packages/core/strategy/double-bb/evidence.ts` (T-17-003: EvidenceResult)
