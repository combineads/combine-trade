# T-085 Calendar collector worker
...
## Inputs
- `packages/core/macro/saveticker-client.ts` (T-084 outputs: SavetickerClient)
- `packages/core/macro/impact-parser.ts` (T-083 outputs: shouldCollect)
- `db/schema/macro.ts` (T-083 outputs: economicEvents table)
