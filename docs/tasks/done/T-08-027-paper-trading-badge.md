# T-08-027 Paper trading mode UI indicators
...
- `packages/ui/src/components/notification-banner.tsx` (from T-08-023) — reference for banner pattern
- `packages/ui/src/components/badge.tsx` (from T-08-012)
...
- PaperBadge placement in order table rows (T-08-017 update)
