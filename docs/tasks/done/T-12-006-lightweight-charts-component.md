# T-12-006 Lightweight Charts integration component
...
## Dependencies
- T-12-001 (packages/ui scaffold with component pattern established)
...
- Strategy event markers overlay (T-12-008)
- Equity curve variant (T-12-009)
- Chart data fetching (T-12-007)
