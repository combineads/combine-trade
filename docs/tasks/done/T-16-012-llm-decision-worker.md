...
## Inputs
- `packages/core/macro/decision-prompt-builder.ts` (T-16-010: buildDecisionPrompt)
- `packages/core/macro/llm-evaluator.ts` (T-16-011: evaluateWithLlm)
