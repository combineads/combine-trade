# T-02-007 Implement Strategy API for sandbox
...
## Inputs
- `packages/core/strategy/sandbox.ts` — Sandbox runtime from T-02-006
- `packages/core/indicator/` — All indicator implementations
- EP02 exec plan M4 specification

## Dependencies
- T-02-006 (sandbox runtime)
...
- Warm-up period handling (T-02-009)
- Strategy worker (T-02-010)
