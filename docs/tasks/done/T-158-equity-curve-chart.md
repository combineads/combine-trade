# T-158 Equity curve chart component
...
## Inputs
- `LightweightChart` primitives and `IChartApi` from T-155
- `lightweight-charts` area series and line series APIs
- `docs/DESIGN_SYSTEM.md` — color tokens
- `packages/ui/src/index.ts` — barrel export

## Dependencies
- T-155 (LightweightChart component, library installed)
