# T-12-001 SSR-safe chart container component
...
## Inputs
- `packages/ui/src/components/skeleton.tsx` — existing skeleton component (from T-08-012)
...
## Dependencies
- T-08-012 (base UI components — skeleton, design tokens)
...
## Out of Scope
- `lightweight-charts` integration (T-12-002, T-12-003)
