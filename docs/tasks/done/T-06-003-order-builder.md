...
## Inputs
- T-06-002 `ExecutionMode`, `requiresOrder` from `packages/execution/mode.ts`
- T-06-002 `packages/execution/types.ts`
...
## Dependencies
- T-06-002 (ExecutionMode type and requiresOrder helper)
