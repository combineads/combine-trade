# T-19-003 wire-auth-entry-point
...
## Inputs
- T-19-002 완료 (better-auth 테이블 존재)
- `apps/api/src/index.ts` — 현재 `stubAuth` 위치 확인
- `packages/auth/` 또는 auth 설정 파일 (EP18 T-18-001에서 작성)
...
## Constraints
- `createAuth` 설정은 EP18 T-18-001 패턴을 따를 것
