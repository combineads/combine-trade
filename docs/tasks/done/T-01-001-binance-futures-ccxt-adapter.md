# T-01-001 Implement Binance Futures CCXT adapter
...
- T-00-001 outputs: monorepo structure with packages/exchange/

## Dependencies
- T-00-001 (monorepo scaffold — packages/exchange/ exists)
...
- No Decimal.js in this layer — prices arrive as numbers from CCXT; conversion to string happens at the repository boundary (T-01-002)
...
- Binance Vision bulk archive download (T-01-005)
