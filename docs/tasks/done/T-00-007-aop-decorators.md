# T-00-007 Implement AOP decorators (@Transactional, @Log)
...
- T-00-001 outputs: `packages/shared/aop/` directory, `packages/shared/logger/` (pino)
- T-00-006 outputs: IoC container for injecting DB transaction context

## Dependencies
- T-00-001 (monorepo structure, pino logger)
- T-00-006 (IoC container — @Transactional needs transaction context injection)
