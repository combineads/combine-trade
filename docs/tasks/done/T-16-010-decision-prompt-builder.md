# T-16-010 Decision prompt builder for LLM 2-stage evaluation
...
## Inputs
- `packages/core/macro/types.ts` (T-16-001: MacroContext)
...
## Out of Scope
- LLM invocation (T-16-011)
- Worker implementation (T-16-012)
